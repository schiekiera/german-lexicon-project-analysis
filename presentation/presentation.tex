...
\begin{frame}
    \frametitle{Recap: Our Data Collection Targets}
    \begin{columns}
        \begin{column}{0.55\textwidth}
            \begin{block}{Stimuli}
                \begin{itemize}
                    \item \textbf{77,500} total items
                    \begin{itemize}
                        \item 38,750 words
                        \item 38,750 nonwords
                    \end{itemize}
                    \item At least \textbf{35 repetitions} per item
                    \item Resulting in \textbf{2,712,500} trials total
                \end{itemize}
            \end{block}
            \begin{block}{Participants}
                \begin{itemize}
                    \item Target: \textbf{2,170} participants
...
\begin{frame}
    ...
    \begin{center}
        ...
        \captionof{figure}{Cumulative data collection from December 2025 onward. Data collection is now \textbf{complete}: as of June 1, 2026, \emph{n} = \textbf{2,830} datasets were collected.
        }
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{block}{Final Counts (Jun 1, 2026)}
                \begin{itemize}
                    \item Datasets collected: \textbf{2,830}
                    \item Retained after cleaning: \textbf{2,479}
                    \item Exclusion rate: \textbf{12.4\%}
                    \item Cleaned trials: \textbf{3,098,750}
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{block}{Target \& Coverage}
                \begin{tabular}{lr}
                    ...
                    Metric & Value \\
                    \midrule
                    Original target (valid) & 2,170 \\
                    Final retained          & 2,479 \\
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \begin{alertblock}{Coverage}
                \small Every item was seen \textbf{$\geq 35$} times (\emph{M} $\approx$ 40), giving stable item-level estimates.
            \end{alertblock}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{center}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \caption{Performance across blocks from \emph{n} = 2,479 participants. (A) Mean accuracy per block across participants. (B) Mean reaction time per block across participants.}
    \end{figure}
\end{frame}
    ...
    \begin{columns}
        \begin{column}{0.40\textwidth}
            \begin{block}{What to report}
                \footnotesize
                \begin{itemize}
                    \item \textbf{A5 = ICC3k $\approx 0.93$} -- internal consistency ($=$ Cronbach's $\alpha$); our headline.
                    \item \textbf{A4 = ICC2k $\approx 0.89$} -- reliability expected in a \emph{new} participant sample.
                    \item A1--A2 are in-house consistency estimates; the spread across A1--A5 reflects estimator and outlier handling.
                \end{itemize}
            \end{block}
...
\begin{frame}
    ...
    \begin{block}{Final Dataset}
        \begin{itemize}
            \item \textbf{2,479} participants retained after cleaning (target: 2,170 -- exceeded)
            \item \textbf{3,098,750} cleaned trials; 12.4\% participant exclusion rate
